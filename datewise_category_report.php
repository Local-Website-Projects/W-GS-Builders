...
<div>
    ...
    <?php
    $query = "SELECT * FROM expenses,categories,sub_categories WHERE expenses.category_id = categories.category_id AND expenses.sub_category_id = sub_categories.sub_category_id AND expenses.category_id='$categoryid' AND (expenses.expense_date BETWEEN '$fdate' AND '$tdate') GROUP BY expenses.category_id";
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tr>
                        <td colspan="9">
                            ...
                            <h4><b><?php echo date_format(date_create_from_format('Y-m-d', $fdate), 'd-m-Y'); ?>
                                    থেকে <?php echo date_format(date_create_from_format('Y-m-d', $tdate), 'd-m-Y'); ?>
                                    তা‌রি‌খের খর‌চের রি‌পোর্ট</b></h4>
                        </td>
                    </tr>
                    <tr>
                        <th>ক্রম</th>
                    ...
                    <?php
                    $query1 = "SELECT * FROM expenses,categories,sub_categories WHERE expenses.category_id = categories.category_id AND expenses.sub_category_id = sub_categories.sub_category_id AND expenses.category_id = '$categoryid' AND (expenses.expense_date BETWEEN '$fdate' AND '$tdate') ORDER BY expenses.expense_date";
