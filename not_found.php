                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-muted mb-0">It's looking like you may not have the authority to visit the
                                website. PLease contact with the admin in order to know more.
                                </p>
                            <p style="display:none"><?php echo $_SERVER['REMOTE_ADDR'] ?></p>
                        </div>
...
<footer class="footer footer-alt">
    <script>document.write(new Date().getFullYear())</script> &copy; Developed by <a href="https://frogbid.com/"
                                                                                     class="text-white-50">FrogBid</a>
</footer>
