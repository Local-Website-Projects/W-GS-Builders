            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">ওয়েবসাইটের তথ্য</h4>
                                <br> <br><br>
                                    ...
                                    if (mysqli_num_rows($data) > 0) {
                                        while ($row = mysqli_fetch_assoc($data)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $row['logo']; ?>" alt="No Image" style="width: 50px;height:50px;border-radius:50%;"></td>
                                                <td><img src="<?php echo $row['favicon']; ?>" alt="No Image" style="width: 50px;height:50px;border-radius:50%;"></td>
                                                <td><?php echo $row['title']; ?></td>
                                                <td><a href="Customization?unique_id=<?php echo $row["unique_id"]; ?>" class="btn btn-dark btn-rounded"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                            </tr>
                                            <?php
                                            $serial_no++;
                                        }
