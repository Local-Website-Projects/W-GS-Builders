            ...
            <div class="mt-2 text-center">
                        ...
                        <div class="table-responsive p-2">
                            <table class="table table-bordered text-center">
                                <thead>
                                <?php
                                $query = "SELECT * FROM `sub_categories`,`expenses` WHERE sub_categories.sub_category_id = $subcategoryid AND expenses.sub_category_id = sub_categories.sub_category_id AND (expenses.expense_date BETWEEN '$fdate' AND '$tdate') group  by sub_categories.sub_category_id";
                                ...
                                <?php
                                $query1 = "SELECT * FROM expenses,categories,sub_categories WHERE expenses.category_id = categories.category_id AND expenses.sub_category_id = sub_categories.sub_category_id AND expenses.sub_category_id = '$subcategoryid' AND (expenses.expense_date BETWEEN '$fdate' AND '$tdate') ORDER BY expenses.expense_date";
