                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title">আয়ের রি‌পোর্ট</h4>
                        </div>
                    </div>
                </div>
                <div class="row mb-3 text-center">
                    <div class="col-4 col-md-4 col-sm-12">
                        <a href="income_report_daily.php" class="btn btn-outline-primary btn-rounded waves-effect waves-light" target="_blank">আজ‌কের রি‌পোর্ট (<?php echo $dt->format('Y-m-d'); ?>)</a>
                    </div>
                    <div class="col-4 col-md-4 col-sm-12">
                        <a href="income_report_monthly.php" class="btn btn-outline-secondary btn-rounded waves-effect waves-light" target="_blank">চল‌তি মা‌সের রি‌পোর্ট (<?php echo $dt->format('F'); ?>)</a>
                    </div>
                    <div class="col-4 col-md-4 col-sm-12">
                        <a href="income_report_yearly.php" class="btn btn-outline-blue btn-rounded waves-effect waves-light" target="_blank">চল‌তি বছ‌রের রি‌পোর্ট (<?php echo $dt->format('Y'); ?>)</a>
                    </div>
                </div>
                <!-- end page title -->
                <div class="row">
                    <div class="col-6 col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
                                <form method="POST" action="category_wise_income_report.php" target="_blank" id="validate_form">
                                    <div class="mb-3">
                    ...
                    <div class="col-6 col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">খর‌চের তালিকা</h4>
                                <br>
                                <form method="POST" action="sub_category_wise_income_report.php" target="_blank" id="validate_form">
                                    <div class="mb-3">
                    ...
                    <div class="col-6 col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
                                <form method="POST" action="datewise_category_income_report.php" target="_blank" id="validate_form">
                                    <div class="mb-3">
                                        <select name="category_id" class="form-select js-select2" style="width:100%;">
                                            <option disabled="disabled" selected="selected" value="">প্রধান খাত নির্বাচন করুন*</option>
                                            <?php
                    ...
                    <div class="col-6 col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <br>
                                <form method="POST" action="datewise_subcategory_income_report.php" target="_blank" id="validate_form">
                                    <div class="mb-3">
                                        <select name="sub_category_id" class="form-select js-select2" style="width:100%;">
                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">তারিখ অনুসারে উপখাতের রিপোর্ট</h4>
                            <br>
                            <form method="POST" action="datewise_income_report.php"" target="_blank" id="validate_form">
                                <div class="row">
